...
import { useDialog, type DialogContext } from "../dialog/dialog";
import {
  RGBA,
  ScrollBoxRenderable,
  TextAttributes,
                ...
                {(option) => {
                  ...
                  return (
                    <box
                      ...
                      onMouseOver={() => {
                        const index = filtered().findIndex((x: any) =>
  ...
  return (
    <>
      ...
      >
        ...
        <span
          style={{
            fg: props.active ? props.theme.background : props.theme.textMuted,
          }}
        >
          {" "}
          {props.description}
